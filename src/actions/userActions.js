...
export const login = (email, password)=> async (dispatch)=>{
    ...
    try {
        ...
        const { data } = await   axios.post('http://localhost:6001/api/users/login' , {email , password} , config)
...
export const register = ( name ,email, password)=> async (dispatch)=>{
    ...
    try {
        ...
        const { data } = await   axios.post('http://localhost:6001/api/users' ,
         { name ,email , password} , 
...
export const getUserDetails = ( id )=> async (dispatch , getState)=>{
    ...
    try {
        ...
        const { data } = await   axios.get(`http://localhost:6001/api/users/${id}` , config)
...
export const  updateUserProfile = ( user )=> async (dispatch , getState)=>{
    ...
    try {
        ...
        const { data } = await   axios.put(`http://localhost:6001/api/users/profile` , user , config)
...
export const  listUsers = ( )=> async (dispatch , getState)=>{
    ...
    try {
        ...
        const { data } = await   axios.get(`http://localhost:6001/api/users` , config)
...
export const  deleteUser = ( id )=> async (dispatch , getState)=>{
    ...
    try {
        ...
        await   axios.delete(`http://localhost:6001/api/users/${id}` , config)
...
export const  updateUser = ( user )=> async (dispatch , getState)=>{
    ...
    try {
        ...
        const { data } = await   axios.put(`http://localhost:6001/api/users/${user._id}` , user, config)
